...
PROJECT_NAME = "survey" or PACKAGE_NAME
PROJECT_PACKAGE = "datasets_survey" or PACKAGE_NAME

REPO_PATH = dirname(PROJECT_PATH)
REPO_NAME = "odl_datasets_survey" or basename(REPO_PATH)
...
SECRET_KEY = r"+7$fz10*^d^kk!=x=jl#8@=7z0n-@_+@-l7av6a6wjk^g-bqsq"
